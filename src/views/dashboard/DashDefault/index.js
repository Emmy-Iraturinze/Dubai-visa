        ...
        <React.Fragment>
            <Row>
                            ...
                            <div className="row d-flex align-items-center">
                                <div className="col-9">
                                    <h3 className="f-w-300 d-flex align-items-center m-b-0">
                                        <i className="feather icon-arrow-up text-c-green f-30 m-r-5" /> 95
                                    </h3>
                                </div>
                ...
                <Col md={6} xl={4}>
                    <Card>
                        <Card.Body>
                            <h6 className="mb-4">Approved Requests</h6>
                            <div className="row d-flex align-items-center">
                                <div className="col-9">
                                    <h3 className="f-w-300 d-flex align-items-center m-b-0">
                ...
                <Col md={6} xl={8}>
                    <Card className="Recent-Users">
                        <Card.Header>
                            <Card.Title as="h5">Recently Requested visas</Card.Title>
                        </Card.Header>
                        ...
                        <Link to="" className="text-center mb-4">See more</Link>
                    </Card>
